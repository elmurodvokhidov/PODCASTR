...
return (
    <section className="mt-10 flex flex-col">
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="mt-12 w-full flex flex-col">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="flex flex-col gap-2.5">
                                ...
                                <FormControl>
                                    <Input className="input-class focus-visible:ring-orange-1" placeholder="Example podcast" {...field} />
                                </FormControl>
